...
const TimeLine = () => {
  ...
  return (
    <>
      <div ref={ref} className="mt-10 mx-40 w-screnn">
        <div className="flex mx-5 md:mx-10 mt-30 md:mt-10 justify-start">
          <div className="mx-5 md:mx-10">
            ...
            >
              <h2 className="md:-mx-4 md:pl-8 md:pr-8 pt-4 pb-6 text-2xl text-[#825dd2] sm:text-4xl xl:text-5xl">
          ...
          <ol className="relative border-l border-gray-200 dark:border-gray-700">
            {experience.map((element) => (
              <li className="mx-5  my-2 md:mb-10 md:ml-4" key={element.id}>
                ...
                <h5 className="text-lg font-semibold text-purple-500 dark:text-white">
                  {element.company}
                </h5>
